...
// systemCustomCmd represents the systemCustom command
var systemCustomCmd = &cobra.Command{
	Use:   "systemCustom",
...
func init() {
	rootCmd.AddCommand(systemCustomCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// systemCustomCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// systemCustomCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
