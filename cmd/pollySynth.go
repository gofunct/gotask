...
// pollySynthCmd represents the pollySynth command
var pollySynthCmd = &cobra.Command{
	Use:   "pollySynth",
...
func init() {
	rootCmd.AddCommand(pollySynthCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// pollySynthCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// pollySynthCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
