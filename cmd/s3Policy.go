...
// s2PolicyCmd represents the s2Policy command
...
func init() {
	...
	// s2PolicyCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// s2PolicyCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
