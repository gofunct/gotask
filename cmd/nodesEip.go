...
// nodesEipCmd represents the nodesEip command
var nodesEipCmd = &cobra.Command{
	Use:   "nodesEip",
...
func init() {
	rootCmd.AddCommand(nodesEipCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// nodesEipCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// nodesEipCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
